...
export const SkillsList: React.FunctionComponent = () => {
  ...
  <p className='text-center md:text-left '><strong>Programming Languages</strong></p>
  <div className='flex flex-wrap justify-center space-x-3 space-y-3 md:justify-start'>
  ...
  <p className='text-center md:text-left'><strong>Frameworks & Libraries </strong></p>
  <div className='flex flex-wrap justify-center space-x-3 space-y-3 md:justify-start'>
  ...
  <img title="Rapids" alt="Rapids" width="100px" src="https://camo.githubusercontent.com/a06b6a44ef25ee9aa6bc319b20e43c11c86325bdf2275761bec0acdaa20fee24/68747470733a2f2f7261706964732e61692f6173736574732f696d616765732f7261706964735f6c6f676f2e706e67"/>
    ...
    &nbsp;
  <p className='text-center md:text-left'><strong>Infrastructure & Softwares</strong></p>
