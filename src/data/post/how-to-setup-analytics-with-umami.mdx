...
Take, for example, a post about technology. Every person who visits the page is recorded, including where they came from _(e.g., Indonesia)_ and what web browser they used _(e.g., Chrome)_.
...
The name fields are the name of our website, we can name it whatever we want, fill in the domain field with your website's domain that you want to monitor, e.g: `megnav.me`, and click **save**.
...
And then grab the embed script, thank you for reading this post, wish you a good day, and see you soon.
